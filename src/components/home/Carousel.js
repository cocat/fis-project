            ...
            <div className="Carousel">
                ...
                <div className="CarouseIllPic">
                    ...
                    <div className="IllPic" >
                        ...
                        <div key="1" className={["IllPic2", this.state.slideIndex === 1 ? "activeIll" : "norIll"].join(' ')}>
                        ...
                        <div key="2" className={["IllPic3", this.state.slideIndex === 2 ? "activeIll" : "norIll"].join(' ')}>
                            <img src={require("../../assets/other/IllusPic3_small@2x.png")} alt="IllusPic1_small" />
                            {/* <img src={require("../../assets/other/IllusPic1_big@2x.png")} alt="IllusPic1_small" /> */}
                            <h3>中等规模项目</h3>
                            <p>利用模块化提升可维护性，灵活适配开发框架</p>
                        </div>
                        <div key="3" className={["IllPic4", this.state.slideIndex === 3 ? "activeIll" : "norIll"].join(' ')}>
